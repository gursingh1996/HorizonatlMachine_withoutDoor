...
class StartPage(Frame):
    def __init__(self, master):
        ...
        pressureValueText = Label(pressureValueFrame, text="2200", fg="black", font=sensorDisplayValueTextFont, width=21, background="#ffffff")
        pressureValueText.grid()
        ...
        voltageValueText = Label(voltageValueFrame, text="220", fg="black", font=sensorDisplayValueTextFont, width=21, background="#ffffff")
        voltageValueText.grid()
        ...
        currentValueText = Label(currentValueFrame, text="20", fg="black", font=sensorDisplayValueTextFont, width=21, background="#ffffff")
        currentValueText.grid()
        ...
        tempValueFrame.grid_propagate(0)
        tempValueText = Label(tempValueFrame, text="45", fg="black", font=sensorDisplayValueTextFont, width=21, background="#ffffff")
        tempValueText.grid()
